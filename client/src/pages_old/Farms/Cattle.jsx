...
import "../../styles/CattleRanch.css"; // Use a different CSS file for the reddish theme
...
const Cattle = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:5000/api/cattleranch");
        const data = await response.json();
        setProducts(data);
      } catch (error) {
        console.error("Error fetching Cattle Ranch products:", error);
      }
    };
    fetchProducts();
  }, []);
  ...
  return (
    <div className="cattle-ranch-page">
      <div className="nav-bar">
        <img src="/images/Cattle.jpeg" alt="Cattle Ranch Logo" />
        <h2>Cattle Ranch</h2>
      ...
      <div className="welcomeMessage">
        <h1 className="welcomeText">Welcome to Cattle Ranch</h1>
      </div>
